...
public class TransitionFunction <T1, T2>{
    ...
    public String toString(){
		// Define iteration
		Iterator<Transition<T1, T2>> it = this.transitions.iterator();
		String res="";
		Transition<T1,T2> tr;
		while(it.hasNext()){
			tr=it.next();
			res=res + tr.getOrig() + " -> " + tr.getDest() + " Tag= " + tr.getTag().getInput() +"/" + tr.getTag().getOutput() + "\n";
		}
		return res;
		//TODOK IMPLEMENT print of all transitions.
    }
